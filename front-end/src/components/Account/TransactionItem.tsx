  ...
  return (
    <FadeUpWrapper delay={(index as number) * 100} key={item?.id}>
      <div
        ...
        className="p-4 cursor-pointer hover:shadow-xl min-w-[485px] transition-all rounded-xl border border-gray-300"
      >
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <CopyOutlined
                ...
                onClick={() => handleCopyClick(item?.order_number as string)}
              />
            </div>
          </div>
      ...
      >
        <div>
          <h4 className="font-semibold text-xl">Order Info</h4>
          ...
          <div className="flex px-4 py-1 justify-between gap-3">
            <DetailItem
              ...
              value={
                <p
                  className={`px-2 py-1 rounded-xl text-center font-semibold ${
                    transactionStatusStyle[
                      item?.paymentStatus?.toLowerCase() as TransactionStatus
                    ] ?? transactionStatusStyle[""]
                  }`}
        ...
        {item?.paymentStatus === "PENDING" && (
          <div className="mt-4">
            ...
            <div className="flex items-center justify-between">
              <DetailItem label="Price Total" value={item?.priceAtPurchases} />
              <DetailItem
              ...
              <DetailItem
                label="VA Numbers"
                value={dataOrder?.va_numbers?.[0]?.va_number}
              />
            </div>
          </div>
        )}
